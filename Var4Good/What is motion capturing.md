...
Hoe zorgen we nu dat we een <span class="blue">persoon kunnen tracken</span>. De markers vertellen ons nog niet wie ze zijn, dus kunnen we niet simpelweg een marker neerzetten op een lichaamsdeel om dat te tracken. De markers moeten op de een of andere manier een identificatie krijgen. Deze fase heet de <span class="blue">labelling</span> fase. Door de markers in een vooraf afgesproken constelatie te plaatsen kan het Vicon systeem de relatieve locaties tussen de markers gebruiken om te labelen. Nu weten we welke marker welke is, het enige wat nog te doen is de markers om te schrijven naar een systeem dat bekend is voor animaties. Avatars in moderne animaties worden vaak aangestuurd door een onderliggend <span class="blue">skelet</span>. Dit skelet kan Vicon berekenen aan de hand van de gelabelde markers in de <span class="blue">solving</span> fase. Bij de labeling fase zijn de markers bekend, maar wat onbekend is is het <span class="blue">midden van elke bone, en de precieze afmetingen van elke bone</span>, onder de markers. De variabiliteit van het bewegen van het pak en de plaatsing van de markers worden weggewerkt tijdens de <span class="blue">Range Of Motion</span> fase (ROM). Door de actor te laten bewegen kan het systeem berekenen hoeveel de markers zich verplaatsen. Het laatste onderdeel van de puzzel is de solve. Tijdens het solven gebruikt het systeem het gekalibreerde skelet en de gelabelde markers om per frame te bepalen hoe het skelet moet draaien en bewegen zodat de virtuele markers op het skelet overeenkomen met de echte gemeten markerposities. Het resultaat is een complete <span class="blue">skeletanimatie</span> die direct bruikbaar is in animatie- en game-engines.

Moderne systemen bieden niet alleen body capture, maar ook <span class="blue">facial motion capture</span>. Een veelgebruikte oplossing hiervoor is <span class="blue">ARKit</span>, de gezichts­trackingtechnologie van Apple. In tegenstelling tot systemen met markers werkt ARKit <span class="blue">markerloos</span> en gebruikt het een combinatie van een dieptesensor en een RGB-camera om het gezicht van de acteur te analyseren.

ARKit detecteert een vooraf gedefinieerde set van zogenaamde <span class="blue">blendshape-coëfficiënten</span>. Dit zijn gewichten die aangeven hoeveel een bepaalde gezichtsuitdrukking (bijvoorbeeld wenkbrauw omhoog, lip krullen, kaak openen) actief is. Het systeem berekent deze waarden realtime op basis van de contouren en diepte-informatie van het gezicht. In tegenstelling tot body capture wordt hier geen skelet opgelost; het gezicht wordt beschreven via een verzameling vormen die op en van elkaar kunnen worden geblend.

Omdat ARKit geen markers nodig heeft, is het snel in te zetten en werkt het goed voor close-ups, maar het is ook gevoeliger voor belichting, camerahoek en occlusies. Voor hoogwaardige productie wordt het daarom vaak gecombineerd met traditionele markergebaseerde facial capture of high-fidelity camera rigs.

Het resultaat is dat we, net als bij een bodiesolve, een set consistente animatiegegevens krijgen die direct op een digitaal gezicht kan worden toegepast. Hierdoor kunnen subtiele expressies van de acteur nauwkeurig worden overgenomen in een 3D-avatar.
